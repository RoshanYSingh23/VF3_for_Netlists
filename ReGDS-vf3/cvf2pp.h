...
namespace lemon {
  ...
  template<class G1 = ListGraph,
           ...
           class D1 = typename G1::template EdgeMap<int>,
           class D2 = typename G2::template EdgeMap<int> >
#endif
  class Vf2pp {
  public:
    ...
    bool feas(const typename G1::Node n1,const typename G2::Node n2) {
      ...
      for(typename G1::IncEdgeIt e1(_g1,n1); e1!=INVALID; ++e1) {
        ...
        if(_mapping[currNode]!=INVALID)
          _conn[_mapping[currNode]] -= _intLabelsEdge1[e1] + 1;
      }
      ...
      for(typename G2::IncEdgeIt e2(_g2,n2); e2!=INVALID; ++e2) {
        ...
        if(connCurrNode<-1)
        {
          connCurrNode += _intLabelsEdge2[e2] + 1;
          // The edge weights are not the same, not isomorphic
          if(MT!=SUBGRAPH && connCurrNode != -1)
          {
            isIso = 0;
            break;
          }
    ...
    bool extMatch(){
      ...
      while(_depth>=0) {
        ...
        if(edgeItOfDepth==INVALID){
          ...
          if(fstMatchedE==INVALID||pairOfNodeOfDepth!=INVALID||is_first_candidate) {
  ...
  public:
    ...
    ///The labels must be the numbers {0,1,2,..,K-1}, where K is the number of
    ///different labels.
    Vf2pp(const G1 &g1, const G2 &g2,M &m, M1 &intLabels1, M2 &intLabels2, D1 &intLabelsEdge1, D2 &intLabelsEdge2) :
      ...
      _intLabelsEdge1(intLabelsEdge1), _intLabelsEdge2(intLabelsEdge2),
    ...
    ~Vf2pp()
    {
      ...
      if(_deallocLabelsAfterUse) {
        delete &_intLabels1;
        delete &_intLabels2;
        delete &_intLabelsEdge1;
        delete &_intLabelsEdge2;
      }
    }
  ...
  protected:
    ...
    bool _local_edgeLabels;
    typedef typename G1::template EdgeMap<int> EdgeLabels1;
    typedef typename G2::template EdgeMap<int> EdgeLabels2;
    void *_edgeLabels1, *_edgeLabels2;
    void createEdgeLabels() {
      _edgeLabels1 = new EdgeLabels1(_g1,0);
      _edgeLabels2 = new EdgeLabels2(_g2,0);
    }

    Vf2ppWizardBase(const G1 &g1,const G2 &g2)
      : _g1(g1), _g2(g2), _mapping_type(SUBGRAPH),
        _local_mapping(1), _local_nodeLabels(1), _local_edgeLabels(1) { }
  };
  ...
  class Vf2ppWizard : public TR {
    ...
    typedef typename TR::EdgeLabels1 EdgeLabels1;
    typedef typename TR::EdgeLabels2 EdgeLabels2;
    ...
    using TR::_edgeLabels1;
    using TR::_edgeLabels2;
  ...
  public:
    ...
    struct SetEdgeLabelsBase : public Base {
      typedef EL1 EdgeLabels1;
      typedef EL2 EdgeLabels2;
      SetEdgeLabelsBase(const Base &b) : Base(b) { }
    };
    ...
    ///the edge labels.
    ///
    ///\param edgeLabels1 A \ref concepts::ReadMap "readable edge map"
    ///of g1 with integer values. In case of K different labels, the labels
    ///must be the numbers {0,1,..,K-1}.
    ///\param edgeLabels2 A \ref concepts::ReadMap "readable edge map"
    ///of g2 with integer values. In case of K different labels, the labels
    ///must be the numbers {0,1,..,K-1}.
    template<typename EL1, typename EL2>
    Vf2ppWizard< SetEdgeLabelsBase<EL1,EL2> >
    edgeLabels(const EL1 &edgeLabels1, const EL2 &edgeLabels2) {
      Base::_local_edgeLabels = 0;
      Base::_edgeLabels1 = reinterpret_cast<void*>(const_cast<EL1*>(&edgeLabels1));
      Base::_edgeLabels2 = reinterpret_cast<void*>(const_cast<EL2*>(&edgeLabels2));
      return Vf2ppWizard<SetEdgeLabelsBase<EL1,EL2> >(SetEdgeLabelsBase<EL1,EL2>(*this));
    }
    ...
    bool run() {
      ...
      if(Base::_local_edgeLabels)
        Base::createEdgeLabels();

      Vf2pp<Graph1, Graph2, Mapping, NodeLabels1, NodeLabels2, EdgeLabels1, EdgeLabels2 >
        alg(_g1, _g2, *reinterpret_cast<Mapping*>(_mapping),
            ...
            *reinterpret_cast<EdgeLabels1*>(_edgeLabels1),
            *reinterpret_cast<EdgeLabels2*>(_edgeLabels2));
      ...
      if(Base::_local_edgeLabels) {
        delete reinterpret_cast<EdgeLabels1*>(_edgeLabels1);
        delete reinterpret_cast<EdgeLabels2*>(_edgeLabels2);
      }
      if(Base::_local_mapping)
    ...
    getPtrToVf2ppObject(){
      ...
      Vf2pp<Graph1, Graph2, Mapping, NodeLabels1, NodeLabels2, EdgeLabels1, EdgeLabels2 >
        alg(_g1, _g2, *reinterpret_cast<Mapping*>(_mapping),
            ...
            *reinterpret_cast<EdgeLabels1*>(_edgeLabels1),
            *reinterpret_cast<EdgeLabels2*>(_edgeLabels2));
      Vf2pp<Graph1, Graph2, Mapping, NodeLabels1, NodeLabels2, EdgeLabels1, EdgeLabels2 >* ptr =
        new Vf2pp<Graph1, Graph2, Mapping, NodeLabels1, NodeLabels2, EdgeLabels1, EdgeLabels2>
